...
class MensClothingCategory extends StatefulWidget {
  const MensClothingCategory({Key? key}) : super(key: key);

  @override
  _MensClothingCategoryState createState() => _MensClothingCategoryState();
}

class _MensClothingCategoryState extends State<MensClothingCategory> {
  ...
  void initState() {
    super.initState();
    categoriesStore.getMensClothingList();
  }
